...
GEMMA_PATH = kagglehub.model_download("google/gemma-3/flax/gemma3-4b-it-int4")
CKPT_PATH = os.path.join(GEMMA_PATH, "gemma3-4b-it-int4")
TOKENIZER_PATH = os.path.join(GEMMA_PATH, 'tokenizer.model')


def main():
    print('INIT')
    model = gm.nn.Gemma3_4B(dtype=jnp.int4)
    print('MODEL_LOAD')
    params = gm.ckpts.load_params(CKPT_PATH, quantize=True)
